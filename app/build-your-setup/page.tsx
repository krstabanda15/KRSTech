...
export default function Builder(){
 ...
 return <div className="container py-12">
  ...
  <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_350px]">
   ...
   <aside className="panel h-fit p-6 lg:sticky lg:top-28"><h2 className="text-xl font-black">Your KRSTech setup</h2><p className="muted mt-1 text-sm">{chosen.length} of 5 components</p>
